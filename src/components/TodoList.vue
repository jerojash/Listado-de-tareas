<template>
    <div class="container mx-auto px-4 py-20 flex flex-col flex-wrap">
        <h1 class="font-hairline text-6xl text-center text-gray-500">List of tasks</h1>

        <todo-card class="mx-auto mt-4 h-64 w-full max-w-lg">
           
            <h1 class="font-hairline text-center text-gray-500">Tasks</h1>
            <div class="flex mb-4">
             <div class="w-4/3 bg-gray-400 h-8">Realizar componentes
